    ...
    <main className='flex flex-col justify-center self-center m-auto p-8 max-w-screen-2xl'>
      <section className=''>
        <div className='py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12'>
          <h1 className=' mb-4 text-4xl font-extrabold tracking-tight leading-none text-blue-infojobs-500  md:text-5xl lg:text-6xl lg:leading-[1.2] dark:text-white'>
      ...
      <section className='flex flex-col lg:flex-row mt-6 gap-5'>
        <aside className='w-full lg:w-1/2 order-1 lg:order-0'>
          <p className='block pb-8 pl-1 text-xl text-blue-infojobs-500'>{totalResults} ofertas encontradas</p>
          <ListOfOffers
