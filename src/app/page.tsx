...
export default async function Home(context: any) {
  ...
  const { listOfOffers, currentPage, totalPages, totalResults } =
    await getInfoJobsOffers(params)
      ...
      <section className="">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <p className="my-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-200">
            Actualmente tenemos <span className="font-bold">{allOffers}</span>{' '}
            ofertas de trabajo listas para ti
          </p>
        </div>
